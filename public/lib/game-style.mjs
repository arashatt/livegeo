...
export function gameStyle(phase='day',lite=false) {
  ...
  return {version:8,projection:{type:'globe'},glyphs:'/vendor/fonts/glyphs/{fontstack}/{range}.pbf',
    ...
    layers:[
      ...
      {id:'roof-light',type:'fill-extrusion',source,'source-layer':'buildings',minzoom:15,layout:{visibility:lite?'none':'visible'},paint:{'fill-extrusion-color':p.roof,'fill-extrusion-height':['+',['get','height'],.2],'fill-extrusion-base':['-',['get','height'],.6],'fill-extrusion-opacity':.65}},
